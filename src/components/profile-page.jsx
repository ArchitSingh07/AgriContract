...
export function ProfilePage({ user, onNavigate }) {
  ...
  const stats = user.userType === 'farmer' ? [
    { label: 'Products Listed', value: '24', icon, color: 'text-blue-500' },
    { label: 'Contracts Signed', value: '18', icon, color: 'text-green-500' },
    { label: 'Total Revenue', value: '$45,200', icon, color: 'text-accent' },
    { label: 'Years Farming', value: '15', icon, color: 'text-purple-500' }
  ] : [
    { label: 'Active Contracts', value: '12', icon, color: 'text-blue-500' },
    { label: 'Completed Deals', value: '28', icon, color: 'text-green-500' },
    { label: 'Total Spent', value: '$32,800', icon, color: 'text-accent' },
    { label: 'Years Buying', value: '8', icon, color: 'text-purple-500' }
  ];
