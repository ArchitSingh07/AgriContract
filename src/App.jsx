...
export default function App() {
    ...
    const [selectedUserType, setSelectedUserType] = useState(null); // "farmer" | "buyer" | null
    ...
    const handleSelectUserType = (userType) => { // userType: "farmer" | "buyer"
        setSelectedUserType(userType);
        setCurrentPage("login");
    };

    const handleLogin = (userType, userData) => { // userType: "farmer" | "buyer", userData: any
    ...
    const handleNavigate = (page, data) => { // page: string, data?: any
        setCurrentPage(page);
        setPageData(data);
    };
